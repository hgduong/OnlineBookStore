                ...
                <div class="col-md-6">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <form action="CategoryEditController" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" 
                                              name="description" maxlength="255" rows="4">${category.description}</textarea>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-warning">
                                        <i class="bi bi-upload me-2"></i>Update Category
                                    </button>
                                </div>
                            </form>
                        </div>
