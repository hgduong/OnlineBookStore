    ...
    <body>
                                    ...
                                    <c:forEach begin="1" end="${totalPages}" var="i">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                ...
                                                <c:url var="pageUrl" value="/book-list"> 
        ...
        <script>
            $(document).ready(function () {
                // Lấy giá trị min và max từ attribute
                var minPrice = ${minPrice != null ? minPrice : 0};
                var maxPrice = ${maxPrice != null ? maxPrice : 600000};
                ...
                $("#sl2").on("slideStop", function (slideEvt) {
                    ...
                    var url = './book-list?minPrice=' + minPrice + '&maxPrice=' + maxPrice;
