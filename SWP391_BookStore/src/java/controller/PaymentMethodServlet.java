 ...
 * @author TungPham
 */
@WebServlet(name = "PaymentMethodServlet", urlPatterns = {"/payment-method"})
public class PaymentMethodServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rq = request.getRequestDispatcher("payment-method.jsp");
