 ...
 * @author TungPham
 */
@WebServlet(name = "MinusCartItemServlet", urlPatterns = {"/minus-cart-item"})
public class MinusCartItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MinusCartItemServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MinusCartItemServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int totalQuantity = cart.getTotalQuantity() - 1;
        if (newQuantity == 0) {
            cartItemDAO.deleteCartItem(cartId, bookId);
        } else {
